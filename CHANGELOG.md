...
- Fix all Read the Docs builds failing: `.readthedocs.yaml` requested the retired `ubuntu-20.04` build image, which fails config validation before any build step runs. Moved to `ubuntu-24.04`
