...
from ipywidgets import Text, HTML, HBox, Layout, VBox,GridBox
...
class VisualSliceEditor:
    ...
    FABRIC_LIGHT = '#f3f3f9'
    FABRIC_WHITE = '#ffffff'
    #FABRIC_LOGO = "/Users/pruth/FABRIC/git/jupyter-examples/fabric_gui/fabric_logo.png"
    FABRIC_LOGO = os.environ['PWD']+"/git/jupyter-examples/fabric_gui/fabric_logo.png"
    ...
    advertised_topology = None
    canvas = None
    slice_manager = None

    available_resources_layer_group = None
    widget_layer_group = None
    current_slice_layer_group = None
    slice_layer_groups = None
    dashboards = None

    base_overflow_y='hidden'
    base_min_height='30px'
    base_layout = Layout(min_height='30px', overflow_y='hidden')

    #VBox for dashbords
    editor_dashboard = None
    ...
    def ant_path(self, path_name, **kwargs):
        print ("ant_path")
    ...
    def update_sites(self):
        ...
        #Add thelinks (TODO: What will this look like?)
        ...
        self.dashboards['node_dashboard']['site_name_hbox'] = widgets.HBox([widgets.Label(value="Site: ",layout=Layout(width='70px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), site_name_widget], layout=self.base_layout)
    ...
    def init_node_dashboard(self):
        ...
        select_node_hbox = widgets.HBox([widgets.Label(value="Select Node: ",layout=Layout(width='150px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), select_node_widget], layout=self.base_layout)
        ...
        node_name_hbox = widgets.HBox([widgets.Label(value="Name: ",layout=Layout(width='70px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), node_name_widget], layout=self.base_layout)
        ...
        site_name_hbox = widgets.HBox([widgets.Label(value="Site: ",layout=Layout(width='70px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), site_name_widget], layout=self.base_layout)
        ...
        core_slider_hbox = widgets.HBox([widgets.Label(value="Cores: ",layout=Layout(width='100px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), core_slider], layout=self.base_layout)
        ...
        ram_slider_hbox = widgets.HBox([widgets.Label(value="RAM (G): ",layout=Layout(width='100px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), ram_slider], layout=self.base_layout)
        dashboard['ram_slider'] = ram_slider
        dashboard['ram_slider_hbox'] = ram_slider_hbox

        disk_slider = widgets.FloatSlider(value=self.DEFAULT_NODE_DISK_VALUE, min=2, max=130, step=0.1, readout_format='1.0f')
        disk_slider_hbox = widgets.HBox([widgets.Label(value="Disk (G): ",layout=Layout(width='100px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), disk_slider], layout=self.base_layout)
        ...
        image_type_widget_hbox = widgets.HBox([widgets.Label(value="Image Type: ",layout=Layout(width='150px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), image_type_widget], layout=self.base_layout)
        ...
        image_widget_hbox = widgets.HBox([widgets.Label(value="Image: ",layout=Layout(width='150px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), image_widget], layout=self.base_layout)
    ...
    def init_slice_dashboard(self):
        ...
        slice_select_widget_hbox = widgets.HBox([widgets.Label(value="Current Slice: ",layout=Layout(width='150px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), slice_select_widget], layout=self.base_layout)
        ...
        slice_status_slice_name_label = widgets.Label(value="Slice Name: ",layout=Layout(width='80px', min_height=self.base_min_height, overflow_y=self.base_overflow_y))
        slice_status_slice_name_value = widgets.Label(value="",layout=Layout(width='150px', min_height=self.base_min_height, overflow_y=self.base_overflow_y))
        dashboard['slice_status_slice_name_value'] = slice_status_slice_name_value
        slice_status_slice_name_widget_hbox = widgets.HBox([ slice_status_slice_name_label, slice_status_slice_name_value])

        slice_status_slice_id_label = widgets.Label(value="Slice ID: ",layout=Layout(width='80px', min_height=self.base_min_height, overflow_y=self.base_overflow_y))
        slice_status_slice_id_value = widgets.Label(value="",layout=Layout(width='150px', min_height=self.base_min_height, overflow_y=self.base_overflow_y))
        ...
        slice_status_slice_state_label = widgets.Label(value="Slice State: ",layout=Layout(width='80px', min_height=self.base_min_height, overflow_y=self.base_overflow_y))
        slice_status_slice_state_value = widgets.Label(value="",layout=Layout(width='150px', min_height=self.base_min_height, overflow_y=self.base_overflow_y))
        dashboard['slice_status_slice_state_value'] = slice_status_slice_state_value
        slice_status_slice_state_widget_hbox = widgets.HBox([ slice_status_slice_state_label, slice_status_slice_state_value])

        slice_status_lease_end_label = widgets.Label(value="Lease End: ",layout=Layout(width='80px', min_height=self.base_min_height, overflow_y=self.base_overflow_y))
        slice_status_lease_end_value = widgets.Label(value="",layout=Layout(width='150px', min_height=self.base_min_height, overflow_y=self.base_overflow_y))
        ...
        slice_status_graph_id_label = widgets.Label(value="Graph ID: ",layout=Layout(width='80px', min_height=self.base_min_height, overflow_y=self.base_overflow_y))
        slice_status_graph_id_value = widgets.Label(value="",layout=Layout(width='150px', min_height=self.base_min_height, overflow_y=self.base_overflow_y))
    ...
    def __init__(self):
        ...
        self.editor_dashboard = widgets.VBox(layout=Layout(height='470px',  width='250px', padding = "4px", overflow_y='scroll', flex_flow='column', display='flex'))
        ...
        self.dashboards['link_dashboard'] = {}
        ...
        self.control_panel = widgets.VBox(layout=Layout(height='135px',  width='250px', overflow_y= 'auto', padding = "4px"))
    ...
    def redraw_slice_map(self):
        ...
        if self.current_experiment == None or not 'topology' in self.current_experiment.keys():
    ...
    def location_plus(self, location, plus_x, plus_y):
    ...
    def add_node(self, node_name):
        try:
            ...
            cap = Capacities()
            cap.set_fields(core=self.DEFAULT_NODE_CORE_VALUE, ram=self.DEFAULT_NODE_RAM_VALUE, disk=self.DEFAULT_NODE_DISK_VALUE)
            new_node.set_properties(capacities=cap, image_type=self.DEFAULT_NODE_IMAGE_TYPE_VALUE, image_ref=self.DEFAULT_NODE_IMAGE_VALUE)
    ...
    def update_select_node_widget_option_name(self, name):
        ...
        self.dashboards['node_dashboard']['select_node_widget'].options = [ '<Choose Node>' ] + sorted(self.get_node_name_list())
        self.dashboards['node_dashboard']['select_node_widget'].value = name
        self.dashboards['node_dashboard']['select_node_widget'].observe(self.node_dashboard_select_node_event, names='value')
    ...
    def node_dashboard_select_node_event(self, change):
        ...
        if old_node_name != self.DEFAULT_NODE_SELECT_VALUE and old_node_name in self.current_experiment['topology'].nodes:
    ...
    def new_slice(self, slice_name):
        ...
        try:
            ...
            if slice_name == None or slice_name == '' or list(filter(lambda experiment: experiment['slice_name'] == slice_name, self.experiments)):
            ...
            experiment['slice_id'] = ''
            experiment['slice_state'] = self.EXPERIMENT_STATE_UNSUBMITTED
            experiment['lease_end'] = ''
            experiment['graph_id'] = ''
            experiment['topology'] = ExperimentTopology()
    ...
    def update_slice_list(self, current_slice_name=None, excludes=[SliceState.Dead, SliceState.Closing]):
        ...
        for slice in existing_slices:
            ...
            experiment['slice_id'] = slice.slice_id
            experiment['slice_state'] = slice.slice_state
            experiment['lease_end'] = slice.lease_end
            experiment['graph_id'] = slice.graph_id
        ...
        for experiment in self.experiments :
            ...
            if current_slice_name != None and experiment['slice_name'] == current_slice_name:
        ...
        if current_slice_name == None and self.experiments:
            current_slice_name = sorted(slice_names)[0]

        self.current_experiment = list(filter(lambda experiment: experiment['slice_name'] == current_slice_name, self.experiments))[0]
    ...
    def slice_dashboard_submit_slice(self, button, **kwargs):
        ...
        status, reservations = self.slice_manager.create(slice_name=self.current_slice_name, slice_graph=slice_graph, ssh_key=self.ssh_key)
    ...
    def node_dashboard_add_component(self, button, **kwargs):
        ...
        component_name_hbox = widgets.HBox([widgets.Label(value="Name: ",layout=Layout(width='70px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), component_name_widget], layout=self.base_layout)
        ...
        component_type_hbox = widgets.HBox([widgets.Label(value="Type: ",layout=Layout(width='70px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), component_type_widget], layout=self.base_layout)
        ...
        component_model_hbox = widgets.HBox([widgets.Label(value="Model: ",layout=Layout(width='70px', min_height=self.base_min_height, overflow_y=self.base_overflow_y)), component_model_widget], layout=self.base_layout)
    ...
    def get_unique_component_name(self):
        num = 1
        name = 'dev'+str(num)
        while len(list(filter(lambda x: x['component_name_widget'].value == name,  self.dashboards['node_dashboard']['components']  ))) > 0:
            num += 1
            name = 'dev'+str(num)
